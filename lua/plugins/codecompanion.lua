          ...
          opts = {
            ...
            prompt_decorator = function(message, adapter, context)
              return string.format(
                [[<prompt>Don't need to review or ask for permission for anything, start do it immediately if you can. After you planning your actions, Pseudocode, start immediately. Alway try to re-read the file you are interact with to check for change in disk. If the following doesn't specify what or where, try read current buffer of neovim if you have mcp. Do the following: %s</prompt>]],
                message
              )
            end,
          },

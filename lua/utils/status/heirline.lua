...
--
-- This module can be loaded with `local astro_heirline = require "utils.status.heirline"`
--
-- @module utils.status.heirline
-- @copyright 2023
...
M.make_buflist = function(component)
  ...
  return require("heirline.utils").make_buflist(
    ...
    function() return vim.t.bufs end, -- use bufs variable
